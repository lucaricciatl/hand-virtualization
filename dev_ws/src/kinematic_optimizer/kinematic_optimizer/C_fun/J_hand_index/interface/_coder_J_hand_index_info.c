 ...
 * File: _coder_J_hand_index_info.c
 *
...
/* Include Files */
#include "_coder_J_hand_index_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("J_hand_index"));
  emlrtSetField(xEntryPoints, 0, "NumberOfInputs", emlrtMxCreateDoubleScalar(9.0));
  emlrtSetField(xEntryPoints, 0, "NumberOfOutputs", emlrtMxCreateDoubleScalar
                (1.0));
  emlrtSetField(xEntryPoints, 0, "ConstantInputs", xInputs);
  emlrtSetField(xEntryPoints, 0, "FullPath", emlrtMxCreateString(
    "C:\\Users\\lucar\\Documents\\MATLAB\\hand_kinematichs\\J_hand_index.m"));
...
/*
 * File trailer for _coder_J_hand_index_info.c
 *
 * [EOF]
 */
